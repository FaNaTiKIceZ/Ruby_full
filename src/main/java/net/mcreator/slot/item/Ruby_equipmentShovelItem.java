...
public class Ruby_equipmentShovelItem extends ShovelItem {
	public Ruby_equipmentShovelItem() {
		super(new Tier() {
			public int getUses() {
				return 2031;
			}
		...
		}, 1, -3f, new Item.Properties().tab(SlotModTabs.TAB_RUBYTAB).fireResistant());
	}
