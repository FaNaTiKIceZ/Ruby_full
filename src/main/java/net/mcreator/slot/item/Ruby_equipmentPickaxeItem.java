...
public class Ruby_equipmentPickaxeItem extends PickaxeItem {
	public Ruby_equipmentPickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 2031;
			}
		...
		}, 1, -2.5f, new Item.Properties().tab(SlotModTabs.TAB_RUBYTAB).fireResistant());
	}
