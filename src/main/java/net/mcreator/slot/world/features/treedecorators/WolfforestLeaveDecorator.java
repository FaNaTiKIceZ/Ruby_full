...
public class WolfforestLeaveDecorator extends LeaveVineDecorator {
	public static final WolfforestLeaveDecorator INSTANCE = new WolfforestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("wolfforest_tree_leave_decorator", tdt);
	}

	public WolfforestLeaveDecorator() {
		super(0.25f);
	}
